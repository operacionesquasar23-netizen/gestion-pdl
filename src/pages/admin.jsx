        ...
        <div className="px-6 py-5 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              ['Fecha Finalización Visita', ticket.FechaFinalizacionVisita ? (() => { const p = ticket.FechaFinalizacionVisita.split('T')[0].split('-'); return p.length === 3 ? `${p[2]}/${p[1]}/${p[0]}` : ticket.FechaFinalizacionVisita.split(',')[0] })() : '—'],
              ['N° OC Visita', ticket.NroOrdenCompraVisita],
              ['Fecha Finalización Habilitación', ticket.FechaFinalizacionHabilitacion ? (() => { const p = ticket.FechaFinalizacionHabilitacion.split('T')[0].split('-'); return p.length === 3 ? `${p[2]}/${p[1]}/${p[0]}` : ticket.FechaFinalizacionHabilitacion.split(',')[0] })() : '—'],
                  ...
                  {filtered.map((t, i) => (
                    <tr key={i} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        {(() => {
                          if (t.Estado === 'Cerrado' || t.Estado === 'Rechazado por tienda') return <span className="text-gray-300">—</span>
